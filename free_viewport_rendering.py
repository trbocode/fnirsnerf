...
def spiral_render(args):
    ...
    imageio.mimwrite(os.path.join('out', '{}_interpolate_rgb_{}x{}_{}.mp4'.format(args.expname, H, W, ckpt_file)), rgbs, fps=30, quality=8)
    imageio.mimwrite(os.path.join('out', '{}_interpolate_depth_{}x{}_{}.mp4'.format(args.expname, H, W, ckpt_file)), depths, fps=30, quality=8)
    pass
