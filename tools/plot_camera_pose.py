...
def main_function(args):
    ...
    min_values, max_values = draw_camera(ax, intr, cam_width, cam_height, scale_focal, extrinsics, True)
    ...
    plt.savefig('./Trajectories/cam_traj_{}.png'.format(exp_dir.split('/')[-1].split('.')[0]))
    print('Done')
